...
(
    ...
    images_store_id bigint REFERENCES public.account (id)  ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.images_store
(
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY
);
...
(
    ...
    storage_id bigint REFERENCES public.post (id)  ON DELETE CASCADE
);
...
DROP TABLE IF EXISTS category CASCADE;
DROP TABLE IF EXISTS images_store CASCADE;
